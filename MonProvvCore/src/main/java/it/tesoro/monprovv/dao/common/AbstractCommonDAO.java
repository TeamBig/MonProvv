package it.tesoro.monprovv.dao.common;
...
public abstract class AbstractCommonDAO <T extends AbstractCommonEntity> {
	...
	public Serializable save( T transientInstance ) {
		...
		try {
			transientInstance = aggiornaMetadati(transientInstance, false);
	...
	public Serializable saveOrUpdate( T transientDetachedInstance ) {
		log.debug("saving "+nomeOggetto + " instance");
		try {
			transientDetachedInstance = aggiornaMetadati(transientDetachedInstance);
	...
	public T merge(T detachedInstance) {
		...
		try {
			detachedInstance = aggiornaMetadati(detachedInstance);
...
//			queryString =  "from " + nomeOggetto + " " + queryString;
	...
	private T aggiornaMetadati(T instance) {
		return aggiornaMetadati(instance, true);
	}
